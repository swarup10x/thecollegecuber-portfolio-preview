            ...
            loader.load(
                ...
                (fbx) => {
                    ...
                    const zConstraint = new CANNON.PointToPointConstraint(
                        ...
                        world.bodies[0], // Assuming the first body is a fixed "ground" body
                        new CANNON.Vec3(
                            boxBody.position.x,
                            boxBody.position.y,
                            0,
        ...
        onMouseMove = (event) => {
            ...
            for (let intersect of intersects) {
                ...
                if (obj) {
                    ...
                    const cornerThreshold = 0.2; // Adjust this value to change the "corner" detection area
                    const isNearCorner =
                    ...
                    if (isNearCorner) {
                        const torqueStrength = 0.1; // Adjust this value to change rotation speed
